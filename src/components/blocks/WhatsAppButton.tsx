...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-[max(env(safe-area-inset-bottom),1.25rem)] right-5 z-40 flex h-12 w-12 items-center justify-center rounded-sm bg-olive text-cream shadow-[0_4px_20px_rgba(43,47,27,0.35)] transition-opacity duration-200 ease-bloom hover:opacity-85"
    >
